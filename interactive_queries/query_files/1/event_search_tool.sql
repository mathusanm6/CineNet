...
-- This query selects events that are scheduled, filtering by event name and country.
-- It joins several tables to aggregate necessary details: user names, event names, and dates.

SELECT U.username, E.name, E.date
FROM Users U
...
WHERE E.status = 'Scheduled' and E.name = :eventname and CO.name = :countryname;
