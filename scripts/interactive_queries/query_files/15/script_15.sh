...
# Welcome message
echo -e "${GREEN}Welcome to the Upcoming Scheduled Event Finding Tool${NC}"
echo "This tool allows you to find the earliest upcoming scheduled event."

# New line
echo

# Answer for the question (french)
echo -e "${YELLOW}Question: Écrivez une requête récursive${NC}"
echo
...
echo "Searching for the earliest upcoming scheduled event..."
